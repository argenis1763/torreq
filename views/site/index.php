    ...
    <section id="project">
        <div class="fullwidthbanner-container slider">
            <div id="slider1" class="slider-img">
                ...
                <div class="img"><img src="<?= Yii::getAlias('@web') ?>/themes/frontend/onepage2/img/bg/pag_02/slider1.jpg" alt="3"></div>
                <div class="img"><img src="<?= Yii::getAlias('@web') ?>/themes/frontend/onepage2/img/bg/pag_02/slider2.jpg" alt="4"></div>
            </div>
